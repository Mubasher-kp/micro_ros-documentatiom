...
int main(void)
{
  ...
  microros_taskHandle = osThreadNew(start_microros_task, NULL, &microros_task_attributes);
...
/* USER CODE BEGIN Header_start_microros_task */
/**
  * @brief  Function implementing the microros_task thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_start_microros_task */
void start_microros_task(void *argument)
{
  /* USER CODE BEGIN 5 */
